...
const faqs = [
  {
    ...
    answer: "Нет, интеграция не требуется. Наша система работает автономно через QR-коды и WhatsApp бота. Кассир просто проверяет код в боте за 30 секунд."
  },
  {
  ...
  },
  {
    ...
    answer: "Это полностью ваше решение. Можно предложить скидку 10-20% или бесплатный десерт. Главное — участие в розыгрыше iPhone каждый месяц."
  },
  {
    question: "Сколько это будет стоить после бесплатного периода?",
    answer: "После тестового периода стоимость составляет всего 15 000 тенге в месяц за безлимитное использование. Это меньше, чем один пост у блогера."
  },
  {
    question: "Будет ли работать в нашем городе?",
    answer: "Да, система работает во всех городах Казахстана. WhatsApp бот поддерживает казахский и русский языки."
  }
];
